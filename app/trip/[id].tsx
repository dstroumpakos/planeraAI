...
const AIRPORT_NAMES: Record<string, string> = {
    ...
    "TLS": "Toulouse Airport (TLS)",
    "BOD": "Bordeaux Airport (BOD)",
    // Germany
    ...
    "BRI": "Bari Airport (BRI)",
    "CTA": "Catania Airport (CTA)",
    "PMO": "Palermo Airport (PMO)",
    // Spain
    ...
    "CRL": "Brussels South Charleroi (CRL)",
    // Portugal
    ...
    "ESB": "Ankara Airport (ESB)",
    "ADB": "Izmir Airport (ADB)",
    "DLM": "Dalaman Airport (DLM)",
    "BJV": "Bodrum Airport (BJV)",
    "NAV": "Nevşehir Cappadocia (NAV)",
    "ASR": "Kayseri Airport (ASR)",
    // UAE
    "DXB": "Dubai International (DXB)",
    "AUH": "Abu Dhabi Airport (AUH)",
    "SHJ": "Sharjah Airport (SHJ)",
    // Qatar
    ...
    // Israel
    "TLV": "Tel Aviv Ben Gurion (TLV)",
    // Jordan
    "AMM": "Amman Queen Alia (AMM)",
    // Oman
    "MCT": "Muscat Airport (MCT)",
    // USA
    ...
    "DCA": "Washington Reagan (DCA)",
    "PHX": "Phoenix Sky Harbor (PHX)",
    "IAH": "Houston Intercontinental (IAH)",
    "MSP": "Minneapolis-St Paul (MSP)",
    "DTW": "Detroit Metro (DTW)",
    ...
    "MSY": "New Orleans Louis Armstrong (MSY)",
    "BNA": "Nashville International (BNA)",
    "AUS": "Austin-Bergstrom (AUS)",
    ...
    "CUN": "Cancún Airport (CUN)",
    "GDL": "Guadalajara Airport (GDL)",
    // Caribbean
    "SJU": "San Juan Luis Muñoz Marín (SJU)",
    "PUJ": "Punta Cana Airport (PUJ)",
    "NAS": "Nassau Airport (NAS)",
    "HAV": "Havana José Martí (HAV)",
    "MBJ": "Montego Bay Airport (MBJ)",
    // Central America
    "SJO": "San José Juan Santamaría (SJO)",
    "PTY": "Panama City Tocumen (PTY)",
    // South America
    ...
    "MDE": "Medellín José María Córdova (MDE)",
    "CTG": "Cartagena Rafael Núñez (CTG)",
    "UIO": "Quito Mariscal Sucre (UIO)",
    "CUZ": "Cusco Alejandro Velasco Astete (CUZ)",
    // Africa
    "CAI": "Cairo International (CAI)",
    "HRG": "Hurghada Airport (HRG)",
    "SSH": "Sharm El Sheikh (SSH)",
    "CMN": "Casablanca Mohammed V (CMN)",
    "RAK": "Marrakech Menara (RAK)",
    "CPT": "Cape Town International (CPT)",
    "JNB": "Johannesburg O.R. Tambo (JNB)",
    "NBO": "Nairobi Jomo Kenyatta (NBO)",
    "ZNZ": "Zanzibar Airport (ZNZ)",
    "LOS": "Lagos Murtala Muhammed (LOS)",
    "ACC": "Accra Kotoka (ACC)",
